    ...
    <div className="flex flex-col h-screen sticky border-r dark:bg-gray-800 dark:border-gray-600">
        ...
        <div className="flex flex-col justify-between flex-1 bg-gray-700 px-4 py-10 w-20">
            <nav>
                ...
                <a className="flex items-center text-gray-50 rounded-md hover:bg-gray-50 hover:text-indigo-700 justify-center h-11" href="#">
                    <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
